      ...
      <div className="landing-content">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '28px' }}>
          ...
          <span style={{ fontSize: '1.8rem', fontWeight: 900, color: 'white', letterSpacing: '-0.03em' }}>
            Vendour<span style={{ color: '#FCD34D' }}>-Mart</span>
          </span>
        </div>

        <div className="landing-badge">
          <Star size={13} fill="#FCD34D" color="#FCD34D" />
          India's Smart Local Marketplace
        </div>
        ...
        <p className="landing-desc">
          Vendour-Mart brings local vendors and customers together on one powerful platform.
